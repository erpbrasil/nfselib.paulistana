...
#
# Generated Wed Jun 24 14:08:31 2026 by generateDS.py version 2.44.3.
...
#   ('--member-specs', 'list')
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v02/PedidoCancelamentoNFe.py')
#
# Command line arguments:
#   schemas/nfse/PedidoCancelamentoNFe_v01.xsd
#
# Command line:
#   generateDS --no-questions --silence --member-specs="list" -f -o "nfselib/paulistana/v02/PedidoCancelamentoNFe.py" schemas/nfse/PedidoCancelamentoNFe_v01.xsd
#
...
class PedidoCancelamentoNFe(GeneratedsSuper):
    ...
    def set_Detalhe(self, Detalhe):
        self.Detalhe = Detalhe
    def add_Detalhe(self, value):
        self.Detalhe.append(value)
    def insert_Detalhe_at(self, index, value):
        self.Detalhe.insert(index, value)
    def replace_Detalhe_at(self, index, value):
        self.Detalhe[index] = value
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoCancelamentoNFe', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoCancelamentoNFe'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoCancelamentoNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DetalheType(GeneratedsSuper):
    ...
    def set_ChaveNFe(self, ChaveNFe):
        self.ChaveNFe = ChaveNFe
    def get_AssinaturaCancelamento(self):
        return self.AssinaturaCancelamento
    def set_AssinaturaCancelamento(self, AssinaturaCancelamento):
        self.AssinaturaCancelamento = AssinaturaCancelamento
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='DetalheType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DetalheType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='DetalheType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
