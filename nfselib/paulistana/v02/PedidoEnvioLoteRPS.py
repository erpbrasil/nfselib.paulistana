...
#   ('--member-specs', 'list')
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v02/PedidoEnvioLoteRPS.py')
#
# Command line arguments:
#   schemas/nfse/PedidoEnvioLoteRPS_v01.xsd
#
# Command line:
#   generateDS --no-questions --silence --member-specs="list" -f -o "nfselib/paulistana/v02/PedidoEnvioLoteRPS.py" schemas/nfse/PedidoEnvioLoteRPS_v01.xsd
#
...
class PedidoEnvioLoteRPS(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos"  xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoEnvioLoteRPS', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoEnvioLoteRPS'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos"  xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoEnvioLoteRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    ...
    ValorTotalServicos -- Informe o valor total dos servi
    ç
    os prestados dos RPS contidos na mensagem XML.
    ValorTotalDeducoes -- Informe o valor total das dedu
    ç
    õ
    es dos RPS contidos na mensagem XML.
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao='1', CPFCNPJRemetente=None, transacao=True, dtInicio=None, dtFim=None, QtdRPS=None, ValorTotalServicos=None, ValorTotalDeducoes=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def set_transacao(self, transacao):
        self.transacao = transacao
    def get_dtInicio(self):
        return self.dtInicio
    def set_dtInicio(self, dtInicio):
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
##     if not silence:
##         sys.stdout.write('#from PedidoEnvioLoteRPS import *\n\n')
##         sys.stdout.write('import PedidoEnvioLoteRPS as model_\n\n')
