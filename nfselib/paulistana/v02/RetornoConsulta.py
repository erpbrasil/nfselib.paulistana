...
#   ('-f', '')
#   ('-o', '/home/luisotavio/Documentos/Projects/produto_12/src/nfselib.paulistana/paulistanalib/v02/RetornoConsulta.py')
#
# Command line arguments:
#   /tmp/generated/schemas/paulistana/v02/RetornoConsulta_v01.xsd
#
# Command line:
#   /home/luisotavio/Documentos/erpbrasil/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/home/luisotavio/Documentos/Projects/produto_12/src/nfselib.paulistana/paulistanalib/v02/RetornoConsulta.py" /tmp/generated/schemas/paulistana/v02/RetornoConsulta_v01.xsd
#
...
class RetornoConsulta(GeneratedsSuper):
    ...
    consultade NFS-e recebidas e consulta de lote.Este Schema XML é
    utilizado pelo Web Service para informar aos tomadores e/ou prestadores
    de serviços o resultado de pedidos de consulta de NFS-e/RPS, consultade
    NFS-e recebidas e consulta de lote."""
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoConsulta', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RetornoConsulta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RetornoConsulta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoConsulta'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoConsulta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
