...
#
# Generated Wed Jun 24 14:08:34 2026 by generateDS.py version 2.44.3.
...
#   ('--member-specs', 'list')
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v02/RetornoInformacoesLote.py')
#
# Command line arguments:
#   schemas/nfse/RetornoInformacoesLote_v01.xsd
#
# Command line:
#   generateDS --no-questions --silence --member-specs="list" -f -o "nfselib/paulistana/v02/RetornoInformacoesLote.py" schemas/nfse/RetornoInformacoesLote_v01.xsd
#
...
#
class RetornoInformacoesLote(GeneratedsSuper):
    """RetornoInformacoesLote -- Schema utilizado para RETORNO de Pedidos de Informa
    ç
    õ
    es de Lote.
    Este Schema XML
    ...
    ç
    os o resultado do pedido de informa
    ç
    õ
    es de lote.
    Cabecalho -- Cabe
    ...
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alerta=None, Erro=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetornoInformacoesLote)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RetornoInformacoesLote.subclass:
            return RetornoInformacoesLote.subclass(*args_, **kwargs_)
        else:
            return RetornoInformacoesLote(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='RetornoInformacoesLote', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetornoInformacoesLote')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'RetornoInformacoesLote':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RetornoInformacoesLote')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RetornoInformacoesLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoInformacoesLote'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='RetornoInformacoesLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class RetornoInformacoesLote
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'RetornoInformacoesLote'
        rootClass = RetornoInformacoesLote
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
##     if not silence:
##         sys.stdout.write('#from RetornoInformacoesLote import *\n\n')
