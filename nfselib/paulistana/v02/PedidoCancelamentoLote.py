...
#   ('--member-specs', 'list')
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v02/PedidoCancelamentoLote.py')
#
# Command line arguments:
#   schemas/nfse/PedidoCancelamentoLote_v01.xsd
#
# Command line:
#   generateDS --no-questions --silence --member-specs="list" -f -o "nfselib/paulistana/v02/PedidoCancelamentoLote.py" schemas/nfse/PedidoCancelamentoLote_v01.xsd
#
...
class PedidoCancelamentoLote(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoCancelamentoLote', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoCancelamentoLote'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoCancelamentoLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpRPS(GeneratedsSuper):
    ...
    ã
    o Paulo.
    EmailTomador -- Informe o e-mail do tomad
    or.
    CPFCNPJIntermediario -- CNPJ do intermedi
    á
    rio de servi
