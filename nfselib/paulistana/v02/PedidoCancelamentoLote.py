...
#   ('-f', '')
#   ('-o', '/home/luisotavio/Documentos/Projects/produto_12/src/nfselib.paulistana/paulistanalib/v02/PedidoCancelamentoLote.py')
#
# Command line arguments:
#   /tmp/generated/schemas/paulistana/v02/PedidoCancelamentoLote_v01.xsd
#
# Command line:
#   /home/luisotavio/Documentos/erpbrasil/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/home/luisotavio/Documentos/Projects/produto_12/src/nfselib.paulistana/paulistanalib/v02/PedidoCancelamentoLote.py" /tmp/generated/schemas/paulistana/v02/PedidoCancelamentoLote_v01.xsd
#
...
class PedidoCancelamentoLote(GeneratedsSuper):
    """Schema utilizado para PEDIDO de cancelamento de lote.Este Schema XML é
    utilizado pelos prestadores de serviços cancelarem as NFS-e geradas a
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoCancelamentoLote', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PedidoCancelamentoLote')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoCancelamentoLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoCancelamentoLote'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoCancelamentoLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    """Cabeçalho do pedido de cancelamento de lote.Informe a Versão do Schema
    XML utilizado."""
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
