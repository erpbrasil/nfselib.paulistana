...
#   ('-f', '')
#   ('-o', '/home/luisotavio/Documentos/Projects/produto_12/src/nfselib.paulistana/paulistanalib/v02/RetornoEnvioLoteRPS.py')
#
# Command line arguments:
#   /tmp/generated/schemas/paulistana/v02/RetornoEnvioLoteRPS_v01.xsd
#
# Command line:
#   /home/luisotavio/Documentos/erpbrasil/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/home/luisotavio/Documentos/Projects/produto_12/src/nfselib.paulistana/paulistanalib/v02/RetornoEnvioLoteRPS.py" /tmp/generated/schemas/paulistana/v02/RetornoEnvioLoteRPS_v01.xsd
#
...
class RetornoEnvioLoteRPS(GeneratedsSuper):
    """Schema utilizado para RETORNO de Pedidos de Envio de lote de RPS.Este
    Schema XML é utilizado pelo Web Service para informar aos prestadores
    de serviços o resultado do pedido de envio de lote de RPS."""
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoEnvioLoteRPS', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RetornoEnvioLoteRPS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RetornoEnvioLoteRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoEnvioLoteRPS'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoEnvioLoteRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    """Cabeçalho do retorno.Versão do Schema XML utilizado."""
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
