...
#   ('--member-specs', 'list')
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v02/RetornoCancelamentoNFe.py')
#
# Command line arguments:
#   schemas/nfse/RetornoCancelamentoNFe_v01.xsd
#
# Command line:
#   generateDS --no-questions --silence --member-specs="list" -f -o "nfselib/paulistana/v02/RetornoCancelamentoNFe.py" schemas/nfse/RetornoCancelamentoNFe_v01.xsd
#
...
#
class RetornoCancelamentoNFe(GeneratedsSuper):
    """RetornoCancelamentoNFe -- Schema utilizado para RETORNO de Pedidos de cancelamento de NFS-e.
    Este Schema XML
    é
    utilizado pelo Web Service para informar aos prestadores de servi
    ç
    os qual o resultado do pedido de cancelamento de NFS-e.
    Cabecalho -- Cabe
    ç
    alho do retorno.
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetornoCancelamentoNFe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RetornoCancelamentoNFe.subclass:
            return RetornoCancelamentoNFe.subclass(*args_, **kwargs_)
        else:
            return RetornoCancelamentoNFe(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='RetornoCancelamentoNFe', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetornoCancelamentoNFe')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'RetornoCancelamentoNFe':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RetornoCancelamentoNFe')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RetornoCancelamentoNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoCancelamentoNFe'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='RetornoCancelamentoNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class RetornoCancelamentoNFe
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao='1', Sucesso=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'RetornoCancelamentoNFe'
        rootClass = RetornoCancelamentoNFe
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
##     if not silence:
##         sys.stdout.write('#from RetornoCancelamentoNFe import *\n\n')
##         sys.stdout.write('import RetornoCancelamentoNFe as model_\n\n')
