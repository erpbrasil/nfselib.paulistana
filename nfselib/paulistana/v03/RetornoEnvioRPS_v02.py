...
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v03/RetornoEnvioRPS_v02.py')
#
# Command line arguments:
#   schemas/nfse/RetornoEnvioRPS_v02.xsd
#
# Command line:
#   /home/kaynnan/.pyenv/versions/3.10.20/bin/generateDS --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "nfselib/paulistana/v03/RetornoEnvioRPS_v02.py" schemas/nfse/RetornoEnvioRPS_v02.xsd
#
...
class RetornoEnvioRPS(GeneratedsSuper):
    """RetornoEnvioRPS -- Schema utilizado para RETORNO de Pedidos de Envio de RPS.
    Este Schema XML
    é
    utilizado pelo Web Service para informar aos prestadores de servi
    ç
    os o resultado do pedido de envio de RPS.
    Cabecalho -- Cabe
    ç
    alho do retorno.
    ...
    member_data_items_ = [
        ...
        MemberSpec_('ChaveNFeRPS', 'tpChaveNFeRPS', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'ChaveNFeRPS', 'type': 'tpChaveNFeRPS'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetornoEnvioRPS)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoEnvioRPS', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetornoEnvioRPS')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'RetornoEnvioRPS':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RetornoEnvioRPS')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RetornoEnvioRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoEnvioRPS'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoEnvioRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ChaveNFeRPS is not None:
            ...
            self.ChaveNFeRPS.export(outfile, level, namespaceprefix_, namespacedef_='', name_='ChaveNFeRPS', pretty_print=pretty_print)
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from RetornoEnvioRPS_v02 import *\n\n')
        sys.stdout.write('import RetornoEnvioRPS_v02 as model_\n\n')
