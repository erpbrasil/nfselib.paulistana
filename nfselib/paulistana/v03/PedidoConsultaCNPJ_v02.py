...
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v03/PedidoConsultaCNPJ_v02.py')
#
# Command line arguments:
#   schemas/nfse/PedidoConsultaCNPJ_v02.xsd
#
# Command line:
#   /home/kaynnan/.pyenv/versions/3.10.20/bin/generateDS --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "nfselib/paulistana/v03/PedidoConsultaCNPJ_v02.py" schemas/nfse/PedidoConsultaCNPJ_v02.xsd
#
...
#
class PedidoConsultaCNPJ(GeneratedsSuper):
    """PedidoConsultaCNPJ -- Schema utilizado para PEDIDO de consultas de CNPJ.
    Este Schema XML
    é
    utilizado pelos tomadores e/ou prestadores de servi
    ç
    os consultarem quais Inscri
    ç
    õ
    ...
    member_data_items_ = [
        ...
        MemberSpec_('CNPJContribuinte', 'tpCPFCNPJ', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'CNPJContribuinte', 'type': 'tpCPFCNPJ'}, None),
        MemberSpec_('Signature', 'SignatureType', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'Signature', 'ref': 'Signature', 'type': 'Signature'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, CNPJContribuinte=None, Signature=None, gds_collector_=None, **kwargs_):
        ...
        self.CNPJContribuinte = CNPJContribuinte
        self.CNPJContribuinte_nsprefix_ = None
        self.Signature = Signature
        self.Signature_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PedidoConsultaCNPJ)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PedidoConsultaCNPJ.subclass:
            return PedidoConsultaCNPJ.subclass(*args_, **kwargs_)
        else:
            return PedidoConsultaCNPJ(*args_, **kwargs_)
    factory = staticmethod(factory)
    def has__content(self):
        if (
            self.Cabecalho is not None or
            self.CNPJContribuinte is not None or
            self.Signature is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoConsultaCNPJ', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PedidoConsultaCNPJ')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PedidoConsultaCNPJ':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PedidoConsultaCNPJ')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoConsultaCNPJ', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoConsultaCNPJ'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoConsultaCNPJ', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CNPJContribuinte is not None:
            namespaceprefix_ = self.CNPJContribuinte_nsprefix_ + ':' if (UseCapturedNS_ and self.CNPJContribuinte_nsprefix_) else ''
            self.CNPJContribuinte.export(outfile, level, namespaceprefix_, namespacedef_='', name_='CNPJContribuinte', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'CNPJContribuinte':
            obj_ = tpCPFCNPJ.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.CNPJContribuinte = obj_
            obj_.original_tagname_ = 'CNPJContribuinte'
        elif nodeName_ == 'Signature':
            obj_ = SignatureType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Signature = obj_
            obj_.original_tagname_ = 'Signature'
# end class PedidoConsultaCNPJ
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'PedidoConsultaCNPJ'
        rootClass = PedidoConsultaCNPJ
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from PedidoConsultaCNPJ_v02 import *\n\n')
        sys.stdout.write('import PedidoConsultaCNPJ_v02 as model_\n\n')
