...
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v03/RetornoEnvioLoteRPS_v02.py')
#
# Command line arguments:
#   schemas/nfse/RetornoEnvioLoteRPS_v02.xsd
#
# Command line:
#   /home/kaynnan/.pyenv/versions/3.10.20/bin/generateDS --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "nfselib/paulistana/v03/RetornoEnvioLoteRPS_v02.py" schemas/nfse/RetornoEnvioLoteRPS_v02.xsd
#
...
class RetornoEnvioLoteRPS(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoEnvioLoteRPS', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoEnvioLoteRPS'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoEnvioLoteRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from RetornoEnvioLoteRPS_v02 import *\n\n')
        sys.stdout.write('import RetornoEnvioLoteRPS_v02 as model_\n\n')
