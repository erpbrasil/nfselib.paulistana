...
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v03/PedidoCancelamentoLote_v02.py')
#
# Command line arguments:
#   schemas/nfse/PedidoCancelamentoLote_v02.xsd
#
# Command line:
#   /home/kaynnan/.pyenv/versions/3.10.20/bin/generateDS --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "nfselib/paulistana/v03/PedidoCancelamentoLote_v02.py" schemas/nfse/PedidoCancelamentoLote_v02.xsd
#
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from PedidoCancelamentoLote_v02 import *\n\n')
        sys.stdout.write('import PedidoCancelamentoLote_v02 as model_\n\n')
