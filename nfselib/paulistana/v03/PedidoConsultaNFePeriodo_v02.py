...
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v03/PedidoConsultaNFePeriodo_v02.py')
#
# Command line arguments:
#   schemas/nfse/PedidoConsultaNFePeriodo_v02.xsd
#
# Command line:
#   /home/kaynnan/.pyenv/versions/3.10.20/bin/generateDS --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "nfselib/paulistana/v03/PedidoConsultaNFePeriodo_v02.py" schemas/nfse/PedidoConsultaNFePeriodo_v02.xsd
#
...
#
class PedidoConsultaNFePeriodo(GeneratedsSuper):
    """PedidoConsultaNFePeriodo -- Schema utilizado para PEDIDO de consulta de NFS-e Emitidas ou Recebidas por per
    í
    odo.
    Este Schema XML
    é
    utilizado pelos Prestadores/Tomadores de servi
    ç
    os consultarem NFS-e Emitidas ou Recebidas por eles.
    Cabecalho -- Cabe
    ç
    alho do pedido.
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PedidoConsultaNFePeriodo)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PedidoConsultaNFePeriodo.subclass:
            return PedidoConsultaNFePeriodo.subclass(*args_, **kwargs_)
        else:
            return PedidoConsultaNFePeriodo(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoConsultaNFePeriodo', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PedidoConsultaNFePeriodo')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PedidoConsultaNFePeriodo':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PedidoConsultaNFePeriodo')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoConsultaNFePeriodo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoConsultaNFePeriodo'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoConsultaNFePeriodo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class RetencaoPisCofins(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tipos:', namespacedef_='', name_='RetencaoPisCofins', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tipos:', name_='RetencaoPisCofins'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='tipos:', namespacedef_='', name_='RetencaoPisCofins', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpRPS(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Assinatura=None, ChaveRPS=None, TipoRPS=None, DataEmissao=None, StatusRPS=None, TributacaoRPS=None, ValorDeducoes=None, ValorPIS=None, ValorCOFINS=None, ValorINSS=None, ValorIR=None, ValorCSLL=None, RetencaoPisCofins=None, CodigoServico=None, AliquotaServicos=None, ISSRetido=None, CPFCNPJTomador=None, InscricaoMunicipalTomador=None, InscricaoEstadualTomador=None, RazaoSocialTomador=None, EnderecoTomador=None, EmailTomador=None, CPFCNPJIntermediario=None, InscricaoMunicipalIntermediario=None, ISSRetidoIntermediario=None, EmailIntermediario=None, Discriminacao=None, ValorCargaTributaria=None, PercentualCargaTributaria=None, FonteCargaTributaria=None, CodigoCEI=None, MatriculaObra=None, MunicipioPrestacao=None, NumeroEncapsulamento=None, ValorTotalRecebido=None, ValorInicialCobrado=None, ValorFinalCobrado=None, ValorMulta=None, ValorJuros=None, ValorIPI=None, ExigibilidadeSuspensa=None, PagamentoParceladoAntecipado=None, NCM=None, NBS=None, atvEvento=None, cLocPrestacao=None, cPaisPrestacao=None, IBSCBS=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
class CabecalhoType(GeneratedsSuper):
    ...
    CPFCNPJ -- Para consulta de NFS-e Recebidas Informe o CNPJ do Tomador.
    Para consulta de NFS-e Emitidas Informe o CNPJ do Prestador.
    Inscricao -- Para consulta de NFS-e Recebidas Informe a Inscri
    ç
    ã
    o Municipal do Tomador.
    Para consulta de NFS-e Emitidas Informe a Inscri
    ç
    ã
    o Municipal do Prestador. Neste caso o preenchimento deste campo se torna obrigat
    ó
    rio.
    ...
    cio do per
    í
    odo a ser consultado (AAAA-MM-DD).
    dtFim -- Informe a data final do per
    í
    odo trasmitido (AAAA-MM-DD).
    NumeroPagina -- Informe o n
    ú
    mero da p
    á
    ...
    member_data_items_ = [
        ...
        MemberSpec_('CPFCNPJRemetente', 'tpCPFCNPJ', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'CPFCNPJRemetente', 'type': 'tpCPFCNPJ'}, None),
        MemberSpec_('CPFCNPJ', 'tpCPFCNPJ', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'CPFCNPJ', 'type': 'tpCPFCNPJ'}, None),
        MemberSpec_('Inscricao', ['tpInscricaoMunicipal', 'xs:long'], 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'Inscricao', 'type': 'xs:long'}, None),
        ...
        MemberSpec_('NumeroPagina', ['tpNumero', 'xs:long'], 0, 0, {'default': '1', 'maxOccurs': '1', 'minOccurs': '1', 'name': 'NumeroPagina', 'type': 'xs:long'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, Versao=None, CPFCNPJRemetente=None, CPFCNPJ=None, Inscricao=None, dtInicio=None, dtFim=None, NumeroPagina=1, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.validate_tpInscricaoMunicipal(self.Inscricao)
        self.Inscricao_nsprefix_ = None
        ...
        self.validate_tpNumero(self.NumeroPagina)
        self.NumeroPagina_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Inscricao is not None:
            namespaceprefix_ = self.Inscricao_nsprefix_ + ':' if (UseCapturedNS_ and self.Inscricao_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricao>%s</%sInscricao>%s' % (namespaceprefix_ , self.gds_format_integer(self.Inscricao, input_name='Inscricao'), namespaceprefix_ , eol_))
        ...
        if self.NumeroPagina is not None:
            namespaceprefix_ = self.NumeroPagina_nsprefix_ + ':' if (UseCapturedNS_ and self.NumeroPagina_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroPagina>%s</%sNumeroPagina>%s' % (namespaceprefix_ , self.gds_format_integer(self.NumeroPagina, input_name='NumeroPagina'), namespaceprefix_ , eol_))
        if self.NumeroPagina is None:
            namespaceprefix_ = self.NumeroPagina_nsprefix_ + ':' if (UseCapturedNS_ and self.NumeroPagina_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroPagina>1</%sNumeroPagina/>%s' % (namespaceprefix_,namespace_prefix, eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'Inscricao' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'Inscricao')
            ival_ = self.gds_validate_integer(ival_, node, 'Inscricao')
            self.Inscricao = ival_
            self.Inscricao_nsprefix_ = child_.prefix
            # validate type tpInscricaoMunicipal
            self.validate_tpInscricaoMunicipal(self.Inscricao)
        ...
        elif nodeName_ == 'NumeroPagina' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'NumeroPagina')
            ival_ = self.gds_validate_integer(ival_, node, 'NumeroPagina')
            self.NumeroPagina = ival_
            self.NumeroPagina_nsprefix_ = child_.prefix
            # validate type tpNumero
            self.validate_tpNumero(self.NumeroPagina)
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'PedidoConsultaNFePeriodo'
        rootClass = PedidoConsultaNFePeriodo
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from PedidoConsultaNFePeriodo_v02 import *\n\n')
        sys.stdout.write('import PedidoConsultaNFePeriodo_v02 as model_\n\n')
