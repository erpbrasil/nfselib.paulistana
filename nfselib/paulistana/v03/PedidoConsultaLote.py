...
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v03/PedidoConsultaLote.py')
#
...
try:
    from nfselib.paulistana.v03.generatedsnamespaces import GenerateDSNamespaceDefs as GenerateDSNamespaceDefs_
