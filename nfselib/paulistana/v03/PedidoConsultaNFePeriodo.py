...
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v03/PedidoConsultaNFePeriodo.py')
#
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from PedidoConsultaNFePeriodo import *\n\n')
        sys.stdout.write('import PedidoConsultaNFePeriodo as model_\n\n')
