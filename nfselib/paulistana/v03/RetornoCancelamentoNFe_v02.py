...
#   ('-f', '')
#   ('-o', 'nfselib/paulistana/v03/RetornoCancelamentoNFe_v02.py')
#
# Command line arguments:
#   schemas/nfse/RetornoCancelamentoNFe_v02.xsd
#
# Command line:
#   /home/kaynnan/.pyenv/versions/3.10.20/bin/generateDS --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "nfselib/paulistana/v03/RetornoCancelamentoNFe_v02.py" schemas/nfse/RetornoCancelamentoNFe_v02.xsd
#
...
class RetornoCancelamentoNFe(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoCancelamentoNFe', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoCancelamentoNFe'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoCancelamentoNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from RetornoCancelamentoNFe_v02 import *\n\n')
        sys.stdout.write('import RetornoCancelamentoNFe_v02 as model_\n\n')
